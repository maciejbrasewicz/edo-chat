...
EdoChat is an intuitive and user-friendly application that allows you to interact with your Snowflake data using natural language queries. Type in your questions or requests, and chat will generate the appropriate SQL query and return the data you need.
...
Here are some example queries you can try with EdoChat:
